                        ...
                        <table class="table table-hover table-borderless">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.program.show', $item) }}" class="btn btn-sm btn-info" title="Lihat">
                                            <i class="ti ti-eye"></i>
                                        </a>
                                        <a href="{{ route('admin.program.edit', $item) }}" class="btn btn-sm btn-warning" title="Edit">
                                            <i class="ti ti-pencil"></i>
                                        </a>
                                        <form action="{{ route('admin.program.destroy', $item) }}" method="POST" style="display:inline;">
                                            @csrf @method('DELETE')
