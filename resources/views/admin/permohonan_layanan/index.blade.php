        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('admin.permohonan_layanan.create') }}" class="btn btn-sm btn-primary">
                        ...
                        <table class="table table-hover table-borderless">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admin.permohonan_layanan.show', $item) }}" class="btn btn-sm btn-info" title="Lihat">
                                            <i class="ti ti-eye"></i>
                                        </a>
                                        <a href="{{ route('admin.permohonan_layanan.edit', $item) }}" class="btn btn-sm btn-warning" title="Edit">
                                            <i class="ti ti-pencil"></i>
                                        </a>
                                        <form action="{{ route('admin.permohonan_layanan.destroy', $item) }}" method="POST" style="display:inline;">
                                            @csrf @method('DELETE')
