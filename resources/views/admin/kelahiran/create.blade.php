                    ...
                    <form method="POST" action="{{ route('admin.kelahiran.store') }}" class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="ibu_nik" class="form-control @error('ibu_nik') is-invalid @enderror" value="{{ old('ibu_nik') }}" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="ayah_nik" class="form-control @error('ayah_nik') is-invalid @enderror" value="{{ old('ayah_nik') }}" required>
