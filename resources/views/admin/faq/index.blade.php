            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h5 class="m-b-10"><i class="ti ti-help-circle me-2"></i>Manajemen FAQ</h5>
                    </div>
                    <ul class="breadcrumb">
                ...
                <div class="card-body">
                    ...
                    <form method="GET" class="mb-3">
                        <div class="input-group">
                            <input type="text" name="search" class="form-control" placeholder="Cari Pertanyaan..." value="{{ $search ?? '' }}">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-borderless">
                            ...
                            <tbody>
                                @forelse ($faq as $item)
                                <tr>
                                    <td><strong>{{ Str::limit($item->pertanyaan, 50) }}</strong></td>
                                    <td><span class="badge badge-info">{{ $item->kategori }}</span></td>
                                    <td>{{ $item->urutan }}</td>
                                    <td>
                                        <a href="{{ route('admin.faq.show', $item) }}" class="btn btn-sm btn-info" title="Lihat">
                                            <i class="ti ti-eye"></i>
                                        </a>
                                        <a href="{{ route('admin.faq.edit', $item) }}" class="btn btn-sm btn-warning" title="Edit">
                                            <i class="ti ti-pencil"></i>
                                        </a>
                                        <form action="{{ route('admin.faq.destroy', $item) }}" method="POST" style="display:inline;">
                                            @csrf @method('DELETE')
