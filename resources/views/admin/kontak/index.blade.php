...
@section('title', 'Manajemen Kontak Desa')
            ...
            <div class="row align-items-center">
                <div class="col-md-12">
                    <div class="page-header-title">
                        <h5 class="m-b-10"><i class="ti ti-phone me-2"></i>Manajemen Kontak Desa</h5>
                    </div>
                    <ul class="breadcrumb">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Daftar Kontak Desa</h5>
                    <a href="{{ route('admin.kontak.create') }}" class="btn btn-sm btn-primary">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('admin.kontak.edit', $item) }}" class="btn btn-sm btn-warning" title="Edit">
                                            <i class="ti ti-pencil"></i>
                                        </a>
                                        <form action="{{ route('admin.kontak.destroy', $item) }}" method="POST" style="display:inline;">
                                            @csrf @method('DELETE')
